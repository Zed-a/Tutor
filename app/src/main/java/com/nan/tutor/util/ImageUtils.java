...
public class ImageUtils {
    ...
    public static void load(Context context, int widthPx, int heightPx,
        ...
        GlideApp.with(context).load(uri).override(widthPx, heightPx).centerCrop().into(imageView);
    }

    public static void loadRound(Context context, int widthPx, int heightPx, String uri, ImageView imageView) {
        GlideApp.with(context).load(uri).override(widthPx, heightPx).centerCrop().apply(RequestOptions.circleCropTransform()).into(imageView);
    }
